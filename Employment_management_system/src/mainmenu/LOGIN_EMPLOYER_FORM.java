...
import all_objects.Employer;
	public class LOGIN_EMPLOYER_FORM extends JFrame {
		...
		public static void main(String[] args) {
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						LOGIN_EMPLOYER_FORM frame = new LOGIN_EMPLOYER_FORM();
		...
		public LOGIN_EMPLOYER_FORM() {
			...
			login.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					 SwingUtilities.invokeLater(() -> new MENUFORM("TO Employment_management_system"));
			...
			JButton forgotPasswordButton = new JButton("Forgot Password?");
		     forgotPasswordButton.addActionListener(new ActionListener() {
		         public void actionPerformed(ActionEvent e) {
		             ...
		             String email = JOptionPane.showInputDialog(LOGIN_EMPLOYER_FORM.this, "Enter your email:");
		             if (email != null && !email.isEmpty()) {
		                 ...
		                 JOptionPane.showMessageDialog(LOGIN_EMPLOYER_FORM.this, "A password reset link has been sent to your email.");
		             } else {
		                 JOptionPane.showMessageDialog(LOGIN_EMPLOYER_FORM.this, "Please enter a valid email.");
		             }
		         }
		     });
		     ...
		     createAccountButton.addActionListener(new ActionListener() {
		         public void actionPerformed(ActionEvent e) {
		        	 ...
		        	 Employer registrationForm = new Employer();
